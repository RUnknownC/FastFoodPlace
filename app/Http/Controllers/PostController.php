    ...
    public function edit($id)
{
    ...
    Gate::define('update-post', function (User $user, Post $post) {
        return $user->id === $post->author_id; // Example: only allow post author to edit
    });
    ...
    public function destroy($id)
{
    ...
    // Debugging: Check current user ID and post author ID
    if (Gate::denies('delete-post', $post)) {
        dd('Current User ID:', auth()->id(), 'Post Author ID:', $post->author_id);
